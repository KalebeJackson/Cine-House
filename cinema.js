...
//console.log(titulo[5])//caractere
//console.log(titulo.indexOf('e'))//saber se um fragmento de texto existe dentro de uma string
//console.log(titulo.slice(9,15))// recorta informações de uma string
...
filmes.forEach(function(filme, index){
    //console.log(index + ' - ' + filme.titulo)// imprime o que determinamos para eles por meio de uma função
})
